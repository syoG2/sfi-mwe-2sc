...
def main(args):
    ...
    df = pd.DataFrame(
        read_jsonl(
            "../data/verb_clustering_c4_framenet/clustering/20-100/bert-base-uncased/word/twostep-xmeans-ward/exemplars_dev.jsonl"
        )
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=Path,
        required=False,
        default="../data/verb_clustering_c4_framenet/embedding/20-100/bert-base-uncased",
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        required=False,
        default="../data/verb_clustering_c4_framenet/best_params_twostep_clustering/20-100/bert-base-uncased/word/twostep-xmeans-ward/best_params.json",
    )
